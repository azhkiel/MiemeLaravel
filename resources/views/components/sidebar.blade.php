        ...
        <nav class="space-y-2">
            ...
            <a href="{{ route('customer.dashboard') }}"
               class="group flex items-center p-3 text-base font-medium rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg
                      {{ request()->routeIs('customer.dashboard') ? 'text-blue-700 bg-gradient-to-r from-blue-50 to-blue-100 shadow-md border-l-4 border-blue-500' : 'text-gray-700 hover:text-blue-700 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50' }}">
                <div class="relative">
            ...
            <a href="{{ route('customer.menu') }}"
               class="group flex items-center p-3 text-base font-medium rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg
                      {{ request()->routeIs('customer.menu') ? 'text-emerald-700 bg-gradient-to-r from-emerald-50 to-emerald-100 shadow-md border-l-4 border-emerald-500' : 'text-gray-700 hover:text-emerald-700 hover:bg-gradient-to-r hover:from-emerald-50 hover:to-teal-50' }}">
                <div class="relative">
                    <i class="fas fa-utensils w-5 h-5 transition-all duration-300 
                            {{ request()->routeIs('customer.menu') ? 'text-emerald-600' : 'text-gray-500 group-hover:text-emerald-600' }}"></i>
            ...
            <a href="{{ route('customer.orders') }}"
               class="group flex items-center p-3 text-base font-medium rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg
                      {{ request()->routeIs('customer.orders') ? 'text-orange-700 bg-gradient-to-r from-orange-50 to-orange-100 shadow-md border-l-4 border-orange-500' : 'text-gray-700 hover:text-orange-700 hover:bg-gradient-to-r hover:from-orange-50 hover:to-red-50' }}">
                <div class="relative">
                    <i class="fas fa-clipboard-list w-5 h-5 transition-all duration-300 
                            {{ request()->routeIs('customer.orders') ? 'text-orange-600' : 'text-gray-500 group-hover:text-orange-600' }}"></i>
            ...
            <a href="{{ route('customer.chart') }}"
               class="group flex items-center p-3 text-base font-medium rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg
                      {{ request()->routeIs('customer.chart') ? 'text-purple-700 bg-gradient-to-r from-purple-50 to-purple-100 shadow-md border-l-4 border-purple-500' : 'text-gray-700 hover:text-purple-700 hover:bg-gradient-to-r hover:from-purple-50 hover:to-pink-50' }}">
                <div class="relative">
                    <i class="fas fa-shopping-cart w-5 h-5 transition-all duration-300 
                            {{ request()->routeIs('customer.chart') ? 'text-purple-600' : 'text-gray-500 group-hover:text-purple-600' }}"></i>
            ...
            <a href="#"
               class="group flex items-center p-3 text-base font-medium rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg
                      {{ request()->routeIs('customer.promo') ? 'text-yellow-700 bg-gradient-to-r from-yellow-50 to-yellow-100 shadow-md border-l-4 border-yellow-500' : 'text-gray-700 hover:text-yellow-700 hover:bg-gradient-to-r hover:from-yellow-50 hover:to-orange-50' }}">
                <div class="relative">
                    <i class="fas fa-tag w-5 h-5 transition-all duration-300 
                            {{ request()->routeIs('customer.promo') ? 'text-yellow-600' : 'text-gray-500 group-hover:text-yellow-600' }}"></i>
