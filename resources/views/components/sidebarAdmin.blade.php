        ...
        <nav class="space-y-2">
            ...
            <a href="{{ route('admin.dashboard') }}"
               class="group flex items-center p-3 text-base font-medium rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg
                      {{ request()->routeIs('admin.dashboard') ? 'text-blue-700 bg-gradient-to-r from-blue-50 to-blue-100 shadow-md border-l-4 border-blue-500' : 'text-gray-700 hover:text-blue-700 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50' }}">
                <div class="relative">
            ...
            <a href="{{ route('admin.orders') }}"
               class="group flex items-center p-3 text-base font-medium rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg
                ...
                <span class="ml-4 transition-all duration-300 font-medium">Pesanan</span>
                <i class="fas fa-chevron-right ml-auto text-xs opacity-0 group-hover:opacity-100 transform translate-x-0 group-hover:translate-x-1 transition-all duration-300 text-gray-400"></i>
            </a>
            ...
            <a href="{{ route('admin.order') }}"
               class="group flex items-center p-3 text-base font-medium rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg
                ...
                <span class="ml-4 transition-all duration-300 font-medium">Manajemen</span>
            </a>
